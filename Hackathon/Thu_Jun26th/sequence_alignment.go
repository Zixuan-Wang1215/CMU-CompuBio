...
func SharedKmers(str1, str2 string, k int) []string {
	shared := []string{}
...
//other problem, find longest subsequence
...
//a better approach to sequence alignment where you can 'slide' different symbols but you can not change the ordering of the sequences
